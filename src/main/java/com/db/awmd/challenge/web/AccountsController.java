...
public class AccountsController {
  ...
  public ResponseEntity<Object> transferAmount(@RequestBody @Valid TransferMoney transfer) {
    log.info("transfer money {0} from {1} to {2}", transfer.getAmount(), transfer.getFromAccountId(),transfer.getToAccountId());
